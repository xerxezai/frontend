...
// deeper shadow), no rotation. Used for "How It Works", "Use Cases" and "Benefits".
    ...
    <section style={{
      ...
      <div className="container" style={{ position: "relative", zIndex: 1 }}>
        <div style={{ maxWidth: 820, display: "flex", flexDirection: "column", gap: 14 }}>
          <Eyebrow color={T.redLight} mb={0}>XERXEZ · FLEET MANAGEMENT SYSTEMS</Eyebrow>
          <h1 style={{
            ...
            Smarter Fleet Operations With GPS, IoT &amp; Real-Time Intelligence
          </h1>
