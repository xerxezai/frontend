...
// deeper shadow), no rotation. Used for "How It Works", "Applications" and "Benefits".
    ...
    <section style={{
      ...
      <div className="container" style={{ position: "relative", zIndex: 1 }}>
        <div style={{ maxWidth: 820, display: "flex", flexDirection: "column", gap: 14 }}>
          <Eyebrow color={T.redLight} mb={0}>XERXEZ · SMART BUILDING SOLUTIONS</Eyebrow>
          <h1 style={{
            ...
            Build Smarter, Safer &amp; More Connected Buildings
          </h1>
