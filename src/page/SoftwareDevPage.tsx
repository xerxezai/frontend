...
const config: ServicePageConfig = {
  ...
  features: [
    ...
    { icon: "fas fa-vials",         title: "Quality Assurance",        desc: "Automated test suites with Jest, Playwright, and Cypress covering unit, integration, and end-to-end flows. Bug escape rate below 0.3% across our portfolio." },
  ...
  steps: [
    ...
    { no: "06", title: "Ongoing Support",        dur: "Ongoing",     desc: "SLA-backed support, security patching, performance tuning, and iterative feature releases. Average client relationship: 5 years after initial delivery." },
  ],
