...
const META: Record<string, DetailMeta> = {
  "ai-erp-platform": {
    ...
    stat: "40%", statLabel: "First-year cost reduction", statPrefix: "", statRaw: 40, statSuffix: "%",
    ...
    results: [
      { metric: "40%", label: "First-year cost reduction", raw: 40, suffix: "%" },
  ...
  "enterprise-saas": {
    desc: "Multi-tenant SaaS platform serving 50+ enterprise clients at 99.9% availability — built from a monolith migration to microservices with zero customer-visible downtime during cutover.",
    tags: ["React", "Node.js", "PostgreSQL", "GCP", "GraphQL", "Redis", "Stripe"],
    stat: "50+", statLabel: "Enterprise clients", statPrefix: "", statRaw: 50, statSuffix: "+",
    ...
    results: [
      { metric: "50+", label: "Enterprise clients served", raw: 50, suffix: "+" },
      { metric: "99.9%", label: "Availability SLA", raw: 99, suffix: "%" },
  ...
  "ai-training-program": {
    desc: "Corporate AI upskilling programme that trained 75+ professionals across 8 enterprise clients — covering ML fundamentals, LLM engineering, and production AI deployment in 8-week project-based cohorts.",
    tags: ["Python", "Jupyter", "LangChain", "OpenAI", "PyTorch", "Hugging Face"],
    stat: "75+", statLabel: "Engineers trained", statPrefix: "", statRaw: 75, statSuffix: "+",
    ...
    results: [
      { metric: "75+", label: "Engineers certified", raw: 75, suffix: "+" },
  ...
  "fraud-detection-mlops": {
    ...
    challenge: "A payments processor was losing $500K monthly to fraud that its rule-based system failed to catch — generating 800 false positives per day while missing sophisticated fraud patterns that emerged within hours of new attack vectors.",
    ...
    results: [
      ...
      { metric: "$500K", label: "Monthly fraud prevented", raw: 500, prefix: "$", suffix: "K" },
    ],
    process: [
  ...
  "multi-cloud-finops": {
    desc: "FinOps platform delivering $500K+ in annual cloud savings across AWS, Azure, and GCP — combining real-time cost visibility, automated rightsizing, and commitment optimisation for a large enterprise.",
    tags: ["Terraform", "Python", "Grafana", "Azure", "AWS", "Snowflake", "dbt"],
    stat: "$500K+", statLabel: "Annual cloud savings", statPrefix: "$", statRaw: 500, statSuffix: "K+",
    ...
    results: [
      { metric: "$500K+", label: "Annual cloud savings", raw: 500, prefix: "$", suffix: "K+" },
  ...
  "llm-engineering-bootcamp": {
    desc: "Intensive 12-week LLM engineering programme graduating 75+ engineers into production-ready AI roles — covering RAG systems, fine-tuning, prompt engineering, and LLM deployment at scale.",
    tags: ["Python", "LangChain", "OpenAI", "Pinecone", "LlamaIndex", "FastAPI", "Hugging Face"],
    stat: "75+", statLabel: "Engineers certified", statPrefix: "", statRaw: 75, statSuffix: "+",
    ...
    process: [
      { step: "01", title: "Cohort Assessment", desc: "Assessed Python, ML, and systems skills across all engineers and grouped cohorts by starting level." },
