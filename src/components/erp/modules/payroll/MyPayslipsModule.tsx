...
function downloadPayslip(row: any, formatAmount: (v: number | string) => string) {
  const content = `
XERXEZ ERP — PAYSLIP
====================
...
-------------------
Basic Salary : ${formatAmount(row.basic)}
Allowances   : ${formatAmount(row.allowances)}
Deductions   : -${formatAmount(row.deductions)}
Gross Salary : ${formatAmount(row.gross)}
NET SALARY   : ${formatAmount(row.net_salary)}
-------------------
              ...
              >
                ...
                <div style={{ padding: '16px 20px' }}>
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 14 }}>
                    {[
                      { label: 'Basic', val: formatAmount(r.basic||0), color: C.dark },
                      { label: 'Allowances', val: `+${formatAmount(r.allowances||0)}`, color: '#3b82f6' },
                      { label: 'Deductions', val: `-${formatAmount(r.deductions||0)}`, color: '#ef4444' },
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    <button onClick={() => downloadPayslip(r, formatAmount)}
