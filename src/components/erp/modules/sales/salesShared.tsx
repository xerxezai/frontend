...
export const Q_STATUS: Record<string, { label: string; bg: string; color: string }> = {
...
export const O_STATUS: Record<string, { label: string; bg: string; color: string }> = {
  open:      { label: 'Pending',   bg: '#f1f5f9', color: '#64748b' },
  confirmed: { label: 'Confirmed', bg: '#dbeafe', color: '#1d4ed8' },
  fulfilled: { label: 'Delivered', bg: '#d1fae5', color: '#065f46' },
  cancelled: { label: 'Cancelled', bg: '#fee2e2', color: '#991b1b' },
};

export const StatusBadge = ({ val, map }: { val: string; map: Record<string, { label: string; bg: string; color: string }> }) => {
  const m = map[val] ?? { label: val, bg: '#f1f5f9', color: '#64748b' };
  return (
