  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: 16 }}>
        {isAdmin && (
          <button onClick={() => { setTF({ ...defT }); setModal('transfer'); }} style={{ background: 'rgba(217,53,34,0.10)', color: OG, border: '1px solid rgba(217,53,34,0.28)', borderRadius: 9, padding: '9px 16px', fontFamily: "'DM Sans',sans-serif", fontWeight: 700, fontSize: 12.5, cursor: 'pointer' }}>
