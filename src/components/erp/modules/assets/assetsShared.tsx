...
export const ASSET_STATUS: Record<string, { label: string; bg: string; color: string }> = {
  active:            { label: 'Active',            bg: '#d1fae5', color: '#065f46' },
  under_maintenance: { label: 'Under Maintenance',  bg: '#fef3c7', color: '#92400e' },
  retired:           { label: 'Retired',            bg: '#e5e7eb', color: '#374151' },
  disposed:          { label: 'Disposed',           bg: '#f1f5f9', color: '#64748b' },
  lost:              { label: 'Lost',                bg: '#fee2e2', color: '#991b1b' },
};

export const ASSET_CATEGORY: Record<string, { label: string; icon: string }> = {
  machinery:    { label: 'Machinery',    icon: 'fas fa-cogs' },
  vehicle:      { label: 'Vehicle',      icon: 'fas fa-truck' },
  equipment:    { label: 'Equipment',    icon: 'fas fa-toolbox' },
  tool:         { label: 'Tool',         icon: 'fas fa-tools' },
  it_equipment: { label: 'IT Equipment', icon: 'fas fa-laptop' },
  safety:       { label: 'Safety',       icon: 'fas fa-hard-hat' },
  other:        { label: 'Other',        icon: 'fas fa-cube' },
};

export const MAINTENANCE_TYPE_LABEL: Record<string, string> = {
  preventive: 'Preventive', corrective: 'Corrective', emergency: 'Emergency', inspection: 'Inspection',
};
