...
export const SHIPMENT_STATUS: Record<string, { label: string; bg: string; color: string }> = {
...
export const DELIVERY_STATUS: Record<string, { label: string; bg: string; color: string }> = {
  delivered: { label: 'Delivered', bg: '#d1fae5', color: '#065f46' },
