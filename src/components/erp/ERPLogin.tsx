    ...
    <div className="min-vh-100 d-flex align-items-center justify-content-center"
      ...
      <div className="bg-white rounded-4 p-4 p-md-5 shadow" style={{ width: '100%', maxWidth: 420 }}>
        <div className="text-center mb-4">
          <img src="/assets/img/logo/xerxez_logo.png" alt="Xerxez" style={{ height: '60px', width: 'auto', background: 'transparent', display: 'block', border: 'none', boxShadow: 'none', margin: '0 auto' }} />
        </div>
