...
const services = [
  ...
  },
  {
    ...
    keyFacts: [
      ...
      { icon: "far fa-rocket", title: "Faster Release Cycles", desc: "Automated testing, infrastructure-as-code, and blue-green deployments eliminate release bottlenecks that used to require manual sign-off at every stage." },
  ...
  },
  {
    ...
    keyFacts: [
      ...
      { icon: "far fa-layer-group", title: "Intelligent Storage Tiering", desc: "Automated policies move data between hot, warm, and cold storage tiers based on access frequency — reducing storage costs without performance impact." },
  ...
  },
  {
    ...
    keyFacts: [
      { icon: "far fa-mobile-alt", title: "Cross-Platform Efficiency", desc: "React Native delivers native-quality performance on both iOS and Android from a single codebase — cutting development time compared to maintaining two separate native apps." },
