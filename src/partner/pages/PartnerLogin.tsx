      ...
      <div style={{ flex: 1, background: CREAM, display: 'flex', alignItems: 'flex-start', justifyContent: 'center', padding: '40px 20px' }}>
        <div style={{
          ...
          <div style={{ textAlign: 'right', marginBottom: 16 }}>
            <a href="mailto:partners@xerxez.com?subject=Partner%20Portal%20Password%20Reset" style={{ fontFamily: FF, fontSize: 12, color: OG, textDecoration: 'none', fontWeight: 600 }}>
              Forgot password?
            </a>
          </div>
